...
class TestAuditRds(unittest.TestCase):
    ...
    def test_database_name(self):
        self.assertEqual(
            self.metric_alarm.alarm_name(),
            self.fixture['AlarmName']
        )
    ...
    def test_dictionary(self):
        ...
        self.assertEqual(
            ...
            {
                'ActionsEnabled': True,
                'AlarmActions': 'AlarmAction1, AlarmActionN',
                'AlarmArn': 'AlarmArn',
                'AlarmDescription': 'AlarmDescription',
                'ComparisonOperator': 'GreaterThanOrEqualToThreshold',
                'StateReason': 'string',
                ...
                'AlarmConfigurationUpdatedTimestamp': str(datetime.datetime(2015, 1, 1, 0, 0)),
                'MetricName': 'string',
                'Namespace': 'string',
